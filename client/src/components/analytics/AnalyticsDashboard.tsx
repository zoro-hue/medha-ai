    ...
    >
      ...
      <motion.div variants={staggerItem} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        <StatCard
          ...
          bgColor="bg-primary-50 dark:bg-primary-950 border border-primary-200 dark:border-primary-800"
        />
        <StatCard
          ...
          bgColor="bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 dark:border-emerald-800"
        />
        <StatCard
          icon={<Target size={18} />}
          label="Quiz Accuracy"
          ...
          bgColor="bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800"
        />
        <StatCard
        ...
        <StatCard
          ...
          bgColor="bg-rose-50 dark:bg-rose-950 border border-rose-200 dark:border-rose-800"
        />
        <StatCard
          icon={<Clock size={18} />}
          label="Time"
